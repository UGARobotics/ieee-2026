...
motor0.set_control(DifferentialVelocityDutyCycle(target_velocity=1, differential_slot=0, differential_position=0))
...
#motor1.set_control(DifferentialVelocityDutyCycle(target_velocity=10, differential_slot=0, differential_position=0))
...
#motor2.set_control(DifferentialVelocityDutyCycle(target_velocity=10, differential_slot=0, differential_position=0))
...
#motor3.set_control(DifferentialVelocityDutyCycle(target_velocity=10, differential_slot=0, differential_position=0))
